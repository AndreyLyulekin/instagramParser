...
console.log(
  '%cЛеонид Залюбовский 2021 | http://www.leoneed.pro | http://Instagram.com/leoneed.pro',
  'color: #1d6ba3; font-size:14px;'
);
console.log(
  '%c--------------------------------------------------------------------------------------',
  'color: #13a555; font-size:16px;'
...
try {
  ...
  function start_parsing() {
    ...
    if (user_name == true) {
      ...
      result_nick_name = result_nick_name
        .match(/[^{}"]+/g)
        .join('')
        .match(/[^,]+/g)
        .join('\n')
    ...
    console.log(
      '%cВыделите собранные имена аккаунтов выше и нажмите CTRL-C, чтобы скопировать.',
      'color: #13a555; font-size:16px;'
    );
    console.log(
      '%cЗаходите подписывайтесь, ставьте лайки! https://Instagram.com/leoneed.pro | http://www.leoneed.pro ',
      'color: #1d6ba3; font-size:14px;'
    );
  }
  // ----------------------------------------------------------------------------------
  ...
  function run_scrolling() {
    ...
    if (
      li_accounts.length != total_count &&
      user_count > li_accounts.length &&
  ...
  console.log(
    '%cНажмите на странице Instagram на Подписчиков или Подписки, и запустите заново скрипт',
